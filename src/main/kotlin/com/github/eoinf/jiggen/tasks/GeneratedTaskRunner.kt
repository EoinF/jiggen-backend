...
class GeneratedTaskRunner(private val executorService: ExecutorService, private val imageFolder: String,
                          private val atlasFolder: String, private val generatedTemplateDao: IGeneratedTemplateDao) {

    fun generateNewTemplate(id: UUID, filePath: String) {
        executorService.submit(GenerateTemplateTask(id, filePath, imageFolder, atlasFolder, generatedTemplateDao))
    }
}